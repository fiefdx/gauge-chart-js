class gauge extends Chart.DoughnutController {
    draw(ease) {
        Chart.DoughnutController.prototype.draw.call(this, ease);
    ...
    initialize(chart, datasetIndex) {
        ...
        Chart.DoughnutController.prototype.initialize.call(this, chart, datasetIndex);
    }
};

gauge.id = "gauge";
gauge.defaults = DoughnutController.defaults;
